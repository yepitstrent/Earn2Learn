<?PHP // $Id: dialogue.php,v 1.1.2.3 2006/02/06 09:59:29 moodler Exp $ 
...
$string['allowmultiple'] = 'Omoguæi više od jednog dijaloga sa istom osobom';
$string['allowstudentdialogues'] = 'Omoguæi dijaloge student - student';
$string['close'] = 'Zatvori';
$string['closed'] = 'Zatvoreno';
$string['confirmclosure'] = 'Upravo zatvarate dijalog sa $a. Zatvoreni dijalozi ne mogu biti ponovo otvoreni. <br /><br /> Ako zatvorite ovaj dijalog možete ga vidjeti, ali ne i ponovo uæi na njega. <br /><br /> Moraæete da zapoènete novi dijalog da nastavite \"prièati\" sa ovom osobom.<br /><br />Da li ste sigurni da želite zatvoriti ovaj dijalog?';
$string['deleteafter'] = 'Obrišite zatvorene dijaloge nakon (dana)';
$string['dialogueclosed'] = 'Dijalog je zatvoren';
$string['dialogueintro'] = 'Uvod u dijalog';
$string['dialoguemail'] = '$a->korisnik je poslao novi unos u Vaš unos za dijalog za \'$a->dijalog\'  Možete ga vidjeti na vašem unosu za dijalog:      $a->url';
$string['dialoguemailhtml'] = '$a->userfrom je poslao novi unos u Vaš unos za dijalog za \'<i>$a->dialogue</i>\'<br /><br /> Možete ga vidjeti na Vašem <a href=\"$a->url\">dijalogu</a>.';
...
$string['maildefault'] = 'Podrazumijevana e-pošta';
...
$string['nosubject'] = 'Predmet nije unešen';
$string['notextentered'] = 'Tekst nije unešen';
$string['notstarted'] = 'Još niste zapoèeli ovaj dijalog';
$string['notyetseen'] = 'Još nije viðeno';
...
$string['pane1'] = '$a dijaloga èeka Vaš odgovor';
$string['pane1one'] = '1 dijalog èeka Vaš odgovor';
$string['pane2'] = '$a dijaloga èeka odgovor od druge osobe';
$string['pane2one'] = '1 dijalog èeka odgovor od druge osobe';
$string['pane3'] = '$a zatvorenih dijaloga';
$string['pane3one'] = '1 zatvoren dijalog';
$string['seen'] = 'Viðeno prije $a';
$string['sendmailmessages'] = 'Pošalji e-poruke o mojim novim unosima';
$string['status'] = 'Status';
$string['studenttostudent'] = 'Student - Student';
$string['subject'] = 'Predmet';
$string['subjectadded'] = 'Predmet dodat';
$string['teachertostudent'] = 'Predavaè - Student';
