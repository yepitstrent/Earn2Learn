<?PHP // $Id: hotpot.php,v 1.3.2.5 2006/02/06 10:00:06 moodler Exp $
...
$string['displayhotpotnext'] = '다음 쟁점 퀴즈 보이기';
$string['displayindexnext'] = '다음 쟁점 퀴즈 색인 보이기';
...
$string['error_noquizzesfound'] = '발견된 쟁점 퀴즈가 없습니다.';
...
$string['modulename'] = '쟁점 퀴즈';
$string['modulenameplural'] = '쟁점 퀴즈';
$string['navigation'] = '향해';
$string['navigation_bar'] = '무들 네비게이션 창';
$string['navigation_buttons'] = '쟁점 퀴즈 누르기';
...
$string['regrade'] = '재성적';
$string['regradecheck'] = '정말 \"$a\" 에 대해 재성적을 원하십니까?';
...
$string['reporthotpotscore'] = '쟁점퀴즈 점수';
...
$string['score'] = '점수';
$string['showhtmlsource'] = 'HTML 소스를 보이시오';
$string['shownextquiz'] = '다음 퀴즈를 보이시오';
$string['showxmlsource'] = 'XML 소스를 보이시오';
