...
$string['editfeeds'] = 'Editar, afegeix subscripcions o cancel·la subscripcions a alimentacions de notícies RSS/Atom';
$string['editnewsfeeds'] = 'Edita alimentacions de notícies';
...
$string['timeoutdesc'] = 'Temps en minuts que una alimentació RSS roman a la memòria cau';
$string['updatefeed'] = 'Actualitza l\'URL d\'una alimentació de notícies';
$string['validatefeed'] = 'Valida alimentació';
