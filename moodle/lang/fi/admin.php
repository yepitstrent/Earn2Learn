<?PHP // $Id: admin.php,v 1.9.2.5 2006/02/06 09:59:42 moodler Exp $ 
...
$string['backgroundcolour'] = 'L‰pikuultava v‰ri';
$string['badwordsconfig'] = 'Kirjoita kiellettyjen sanojen lista pilkuin erotettuna.';
$string['badwordsdefault'] = 'Jos oma kiellettyjen sanojen lista on tyhj‰, k‰ytet‰‰n kielipaketissa olevaa oletussanalistaa.';
...
$string['configdefaultallowedmodules'] = 'Mitk‰ moduulit haluat sallia oletuksena niille kursseille, jotka kuuluvat t‰h‰n kategoriaan, <b>kun nuo kurssit luodaan</b>?';
$string['configdefaultrequestedcategory'] = 'Toivottujen kurssien oletuskategoria, johon ne sijoitetaan jos kurssi hyv‰ksyt‰‰n.';
...
$string['configenablecourserequests'] = 'T‰ss‰ voit antaa kaikille k‰ytt‰jille mahdollisuuden toivoa uuden kurssin luomista.';
...
$string['configrequestedstudentname'] = 'K‰ytett‰v‰ sana oppilaalle toivotuilla kursseilla';
$string['configrequestedstudentsname'] = 'K‰ytett‰v‰ sana oppilaille toivotuilla kursseilla';
$string['configrequestedteachername'] = 'K‰ytett‰v‰ sana opettajalle toivotuilla kursseilla';
$string['configrequestedteachersname'] = 'K‰ytett‰v‰ sana opettajille toivotuilla kursseilla';
$string['configrestrictbydefault'] = 'Pit‰isikˆ uusien kurssien, jotka luodaan ja kuuluvat yll‰ mainittuun kategoriaan, moduulit rajoittaa oletusarvoisesti?';
$string['configrestrictmodulesfor'] = 'Mill‰ kursseilla pit‰isi olla <b>asetus</b> joidenkin toimintomoduuleiden ottamiseksi pois k‰ytˆst‰?';
