<?PHP // $Id: block_quiz_results.php,v 1.2.2.5 2006/02/06 10:00:33 moodler Exp $ 
      // block_quiz_results.php - created with Moodle 1.6 development (2005053000)
...
$string['config_no_quizzes_in_course'] = 'Tento kurz neobsahuje ¾iadne testy. Musíte prida» aspoò jeden test, aby ste mohli pou¾íva» tento blok korektne.';
$string['config_select_quiz'] = 'Výsledky ktorého testu má tento blok obsahova»?';
...
$string['configuredtoshownothing'] = 'Nastavenie bloku momentálne nepovoµuje zobrazovanie ¾iadnych výsledkov. Mali by ste tento blok nakonfigurova» alebo ho skry».';
...
$string['error_emptyquizrecord'] = 'V tomto bloku sa vyskytla chyba: zvolený test nebol nájdený v databáze.';
$string['error_nogroupsexist'] = 'V tomto bloku sa vyskytla chyba: v systéme je nastavené, ¾e sa známky majú zobrazova» za skupiny, ale tento kurz nemá definované ¾iadne skupiny.';
