<?PHP // $Id: message.php,v 1.1.2.5 2006/02/06 10:00:34 moodler Exp $ 
...
$string['allusers'] = 'V¹etky správy od v¹etkých pou¾ívateµov';
...
$string['blockedmessages'] = '$a správa(y) pre/od blokovaných pou¾ívateµov';
...
$string['offlinecontacts'] = 'Nepripojení pou¾ívatelia ($a)';
$string['online'] = 'Pripojený';
$string['onlinecontacts'] = 'Pripojení pou¾ívatelia ($a)';
...
$string['userisblockingyou'] = 'Tento pou¾ívateµ má nastavené blokovanie správ od teba';
$string['userisblockingyounoncontact'] = 'Tento pou¾ívateµ prijíma správy iba od µudí, ktorých má zapísaných vo svojom zozname kontaktov a ty sa v òom nenachádza¹. ';
$string['userssearchresults'] = 'Výsledok hµadania: $a nájdených pou¾ívateµov';
