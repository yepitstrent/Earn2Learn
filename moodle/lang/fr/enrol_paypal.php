<?php // $Id: enrol_paypal.php,v 1.4.2.3 2006/02/06 09:59:43 moodler Exp $ 
...
$string['description'] = 'Le module Paypal permet de mettre en place des cours payant. Si le coût d\'un cours est 0, les étudiants peuvent s\'y inscrire sans payer. Un coût défini globalement, que vous fixez ici, est le coût par défaut pour tous les cours du site. Chaque cours peut ensuite avoir un coût spécifique fixé individuellement. S\'il est défini, le coût spécifique d\'un cours remplace le coût par défaut.';
