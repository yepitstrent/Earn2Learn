<?PHP // $Id: wiki.php,v 1.2.2.5 2006/02/06 10:00:07 moodler Exp $ 
      // wiki.php - created with Moodle 1.6 development (2005100400)


$string['action'] = '활동';
$string['administration'] = '관리';
$string['allowremovepages'] = '페이지 지움 허용';
$string['allowrevertchanges'] = '다중변환 허용';
$string['allowsetpage'] = '페이지 표기 허용';
$string['allowstrippages'] = '페이지버리기 허용';
...
$string['disablecamel'] = 'CamelCase 링크를 불가능하게 하다';
...
$string['editform2'] = '현명하게 작성하십시오. 그리고 모든 편집은 기록된다는 것을 명심하십시오';
...
$string['removepagecheck'] = '당신이 원했던 면들을 정말로 지우시겠습니까?';
