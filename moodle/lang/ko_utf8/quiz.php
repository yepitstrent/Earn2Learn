<?PHP // $Id: quiz.php,v 1.2.2.5 2006/02/06 10:00:07 moodler Exp $ 
      // quiz.php - created with Moodle 1.6 development (2005100400)
...
$string['answerswithacceptederrormarginmustbenumeric'] = '허용 오차를 포함한 답은 숫자로 표시되어져야 합니다.';
$string['answertoolong'] = '$a 째 출의 답이 너무 깁니다.';
$string['aon'] = 'AON포멧';
...
$string['errorsdetected'] = '$a 개의 에러가 발견되었습니다.';
$string['event1'] = '자동저장';
$string['event2'] = '저장';
$string['event3'] = '성적';
$string['event5'] = '유효함';
...
$string['missingquestion'] = '$a 줄 이후 문항 라벨 빠짐';
...
$string['toomanyrandom'] = '카테고리에 저장된 질문보다 랜덤형식의 질문이 더 많습니다! ($a)';
$string['top'] = '위';
$string['true'] = '진실';
