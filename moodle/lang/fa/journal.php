<?PHP // $Id: journal.php,v 1.2.12.3 2006/02/06 09:59:42 moodler Exp $ 
      // journal.php - created with Moodle 1.3 Beta + (2004051600)


$string['alwaysopen'] = 'Always open';
$string['blankentry'] = 'Blank entry';
$string['daysavailable'] = 'ÊÚÏÇÏ ÑæÒ ÞÇÈá ÇÓÊÝÇÏå';
...
$string['journalname'] = 'äÇã ÑæÒäÇãå';
$string['journalquestion'] = 'ÓÆæÇá ÑæÒäÇãå';
$string['journalrating1'] = 'Not satisfactory';
$string['journalrating2'] = 'Satisfactory';
$string['journalrating3'] = 'Outstanding';
$string['modulename'] = 'ÑæÒäÇãå';
$string['modulenameplural'] = 'ÑæÒäÇãå åÇ';
...
$string['notstarted'] = 'åäæÒ Ç&#1740;ä ÑæÒäÇãå ÑÇ ÔÑæÚ ä˜ÑÏå Ç&#1740;Ï';
$string['overallrating'] = 'Overall rating';
$string['rate'] = 'Rate';
$string['saveallfeedback'] = 'ÊãÇã ÌæÇÈåÇ&#1740; ãä ÑÇ ÐÎ&#1740;Ñå ˜ä';
$string['startoredit'] = 'Start or edit my journal entry';
$string['viewallentries'] = 'Ï&#1740;Ïä $a ãæÑÏ ÏÑ ÑæÒäÇãå';
