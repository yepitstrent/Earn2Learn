<?php // $Id: files.php,v 1.1.2.4 2006/02/06 10:00:39 moodler Exp $
      // Names of the documentation files
      // Files with a definition "-" are treated as spacers

$string['-about'] = "Hinggil sa Moodle";
$string['intro.html'] = "Introduksiyon";
$string['background.html'] = "Kasaysayan";
