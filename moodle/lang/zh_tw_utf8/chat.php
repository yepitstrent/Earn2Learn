<?PHP // $Id: chat.php,v 1.1.12.3 2006/02/06 10:00:44 moodler Exp $ 
...
$string['explainmethoddaemon'] = '這些設定<strong>只有</strong>當你選擇聊天室模式為聊天伺服器daemon 才有效 ';
$string['explainmethodnormal'] = '這些設定<strong>只有</strong>當你選擇聊天室模式為普通模式才有效';
