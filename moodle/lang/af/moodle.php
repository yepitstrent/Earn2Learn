<?PHP // $Id: moodle.php,v 1.4.2.3 2006/02/06 09:59:25 moodler Exp $ 
...
$string['emailconfirmsent'] = '<p>\'n Email is veronderstel om gestuur te wees na jou adres - <b>$a</b> </p>
<p>Dit bevat maklike instruksies om jou registrasie te voltooi.</p>
<p>As jy probleme ondervind, kontak die blad administrateur.</p>';
...
$string['emailpasswordsent'] = 'Dankie dat jy die verandering van jou wagwoord bevestig het.
\'n Email wat jou nuwe wagwoord bevat is gestuur na <br /><b>$a->email</b>.<br />
Die nuwe wagwoord was outomaties gegenereer - jy kan jou wagwoord verander na iets wat makliker is om te onthou. <a href=\"$a->link\">Verander jou wagwoord hier</a>';
...
$string['loginsteps'] = 'Hallo! Vir volle toegang tot die kursusse moet jy vir jouself \'n rekening skep op die blad.    Party kursusse mag dalk \'n     \"registrasie sleutel\" benodig. Hier is die stappe:    
<ol>
<li>Vul die  <A HREF=$a>Nuwe Rekening</A> vorm in met jou details.</li>
<li>\'n Email sal dadelik aan jou email adres gestuur word.</li>
<li>Lees jou email, en klik op die skakel wat dit bevat.</li>
<li>Jou rekening sal bevestig wees en jy sal ingeteken wees.</li>
<li>Kies die kursus waaraan jy wil deelneem.</li>  <li>As jy gevra word vir \'n  \"registrasie sleutel\" - gee die sleutel wat deur jou onderwyser voorsien is. Dit sal jou \"inskryf\" in die kursus.</li>    <li>Jy het nou toegang tot die voledige kursus. Van nou af sal jy net jou gebruikersnaam en wagwoord benodig(in die vorm op die blad) om toegang te verkry tot die web blad en die kurusse waarvoor jy ingeskryf is.</li>
</ol>';
$string['loginstepsnone'] = '<p>Hallo!</p>
<p>Vir volle toegang tot die kursus moet jy \'n rekening skep.</p>
<p>Al wat jy hoef te doen is om \'n gebruikernaam en wagwoord uit te dink en in te vul op die vorm op die bladsy!</p>
<p>As iemand klaar die gebruikernaam gekies het, sal jy \'n ander gebruikernaam moet gebruik.</p>';
...
Jou rekening wagwoord by \'$a->sitename\' is herstel en \'n tydlike wagwoord is aan jou uitgereik.  

Jou huidige inteken inligting: 	
gebruikersnaam: $a->username 	
wagwoord: $a->newpassword  

Gaan asb. na die bladsy om jou wagwoord te verander:    $a->link  

In meeste programe sal dit as \'n blou skakel vertoon word waarop jy slegs hoef te klik. As dit nie werk nie, sny die adres uit en plak dit in die adres lyn bo aan jou \'browser\'.  

Dankie vanaf die \'$a->sitename\' administrateur, $a->signoff ';
...
$string['passwordsenttext'] = '<p>\'n Email is gestuur na jou adres - $a->email.</p>
<p><b>Lees die email vir jou nuwe wagwoord</b> </p>   <p>Die wagwoord is outomaties gegenereer, as jy wil    <a href=$a->link>verander dit na iets makliker om te onthou</a>.</p>';
$string['people'] = 'Mense';
...
$string['registrationinfo'] = '<p>Registreer op die bladsy jou Moodle webblad by moodle.org.  Registrasie is gratis. Die belangrike voordeel van registrasie is dat jy op \'n poslys geplaas word, almal op die lys kry belangrike kennisgewings soos sekuriteit waarskuwings of nuwe weergawes van Moodle.</p>
<p>Jou inligting word privaat gehou en word aan niemand verkoop of gegee nie.  Die inligting word versamel vir ondersteunings doeleindes, en om statistiek op te bou oor die algehele Moodle gemeenskap.</p>
<p>Jy kan jou blad naam, land en URL laat vertoon op \'n publieke lys van Moodle bladsye.</p>
<p>Alle registasies sal eers met die hand gekontroleer word voordat dit by die lys gevoeg word, jy kan jou registrasie (en inskrywing op die publiekelys) enige tyd verander deur die vorm weer in te vul en in te stuur.</p>';
...
$string['searchhelp'] = 'Jy kan vir meer as een woord op \'n slag soek.<br /><br />woord: soek vir enige bypassende woord in die teks. 
