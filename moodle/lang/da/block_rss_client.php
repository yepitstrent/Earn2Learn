<?PHP // $Id: block_rss_client.php,v 1.3.2.3 2006/02/06 09:59:32 moodler Exp $ 
...
$string['displaydescriptionlabel'] = 'Vis beskrivelse for hvert link?';
$string['editfeeds'] = 'Ret, abonner eller afmeld fra en RSS/Atom nyhedsservice.';
$string['editnewsfeeds'] = 'Ret nyhedskilder';
$string['editrssblock'] = 'Ret RSS overskrifts blok';
...
$string['timeoutdesc'] = 'Tid i minutter som RSS nyheder kan caches i';
$string['updatefeed'] = 'Opdater en nyhedsservice';
$string['validatefeed'] = 'Valider service';
