<?PHP // $Id: dialogue.php,v 1.2.2.3 2006/02/06 09:59:26 moodler Exp $ 
      // dialogue.php - created with Moodle 1.4.3 + (2004083131)


$string['addmynewentries'] = 'Дадаць мае новыя запісы';
$string['addmynewentry'] = 'Дадаць мой новы запіс';
$string['addsubject'] = 'Дадаць Тэму ';
...
$string['dialoguemailhtml'] = 'Ад $a->userfrom быў дасланы новы запіс у Вашы дыялог для \'<i>$a->dialogue</i>\'<br /><br />
Вы можаце ўбачыць як гэта адбылося падчас Вашага ўваходу ў <a href=\"$a->url\">Дыялог</a>.';
