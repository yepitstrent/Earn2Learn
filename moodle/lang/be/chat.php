<?PHP // $Id: chat.php,v 1.3.2.3 2006/02/06 09:59:26 moodler Exp $ 
...
$string['explainmethoddaemon'] = 'Гэтыя настройкі маюць значэнне <strong>толькі</strong>, калі Вы ў якасці метада чата выбралі дэман чат-сервера';
