<?php // $Id: error.php,v 1.3.2.3 2006/02/06 09:59:47 moodler Exp $ 
      // error.php - created with Moodle 1.2 development (2003122600)

$string['adminprimarynoedit'] = 'Az elsõdleges rendszergazda adatait mások nem szerkeszthetik.';
...
$string['fieldrequired'] = 'A(z) \"$a\" kitöltendõ mezõ';
...
$string['missingfield'] = 'A(z) \"$a\" mezõ hiányzik';
...
$string['sessionerroruser2'] = 'Bejelentkezési szerverhiba keletkezett. Kérjük, jelentkezzen be újra vagy indítsa újra a böngészõt.';
$string['statscatchupmode'] = 'A statisztika jelenleg készülõfélben van. Eddig $a->daysdone nao feldolgozására került sor és  $a->dayspending nap van még hátra. Térjen vissza rövidesen!';
