<?PHP // $Id: assignment.php,v 1.12.2.4 2006/02/06 10:00:25 moodler Exp $ 
...
$string['availabledate'] = 'Data rozpoczêcia';
...
$string['emptysubmission'] = 'Nie odda³e¶ jeszcze zadania';
...
$string['guestnoupload'] = 'Przepraszamy, u¿ytkownik zalogowany joko go¶æ przes³aæ';
$string['helpoffline'] = '<p>To jest u¿yteczne kiedy zadanie jest wykonywane poza Moodle. 
<p>Studenci mog± widzieæ opis zadania, ale nie mog± przes³aæ pliku. Oceniasz prace normalnie, i studenci bêd± otrzymywaæ zawiadomienia o stopniach. ';
$string['helponline'] = '<p>Ten typ zadania wymaga od u¿ytkowników redagowania tekstu, za pomoc± programów do edycji. Nauczyciel mo¿e wystawiæ stopieñ on-line, i dodawaæ komentarze lub wprawadzaæ zmiany. </p><p>(Je¿eli znacie starsze wersje Moodle, ten typ zadania odpowiada  dziennikowi,) </p>';
$string['helpuploadsingle'] = '<p>Ten typ zadania pozwala ka¿demu uczestnikowi przes³ac jeden plik, dowolnego typu. <p>To mo¿e byæ dokument, obraz,albo plik skompresowany, itp. ';
...
$string['noassignments'] = 'Nie przes³ano jeszcze rozwi±zañ';
$string['noattempts'] = 'Nie próbowano rozwi±zaæ zadania';
...
$string['typeonline'] = 'Dzia³ania wykonywane w trybie on-line';
