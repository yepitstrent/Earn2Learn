<?PHP // $Id: journal.php,v 1.7.12.5 2006/03/08 18:40:25 koenr Exp $ 
      // journal.php - created with Moodle 1.2 (2004032000)
...
Du kan lese den nedenfor innlegget:

$a->url';
$string['journalmailhtml'] = '$a->teacher har gitt tilbakemelding til ditt journalinnlegg i \'<i>$a->journal</i>\'<br /><br />
Du kan lese den nedenfor <a href=\"$a->url\">innlegget ditt</a>.';
...
$string['rate'] = 'Vurder';
$string['saveallfeedback'] = 'Lagre og send min(e) tilbakemelding(er)';
