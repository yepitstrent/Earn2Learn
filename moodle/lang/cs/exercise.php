<?PHP // $Id: exercise.php,v 1.5.2.4 2006/02/06 09:59:32 moodler Exp $ 
...
$string['assessmentform'] = 'Hodnotící formuláø';
...
$string['atthisstageyou'] = 'V tomto stádiu jste dokonèili hodnocení.<br />
Na jeho základì mù¾ete chtít svoji práci pøepracovat.<br /> 
...
nebo HTML souboru. Tento soubor se zkopíruje do cvièení døíve, ne¾ mají
$a cvièení zpøístupnìno. Je také mo¾no vytvoøit sadu variant tého¾ cvièení 
...
vyma¾te jedno z tìchto øe¹ení.';
$string['duedate'] = 'Datum uzávìrky';
$string['edit'] = 'Upravit';
...
$string['multiplesubmissions'] = 'Vícenásobné øe¹ení';
$string['noexercisedescriptionssubmitted'] = 'Nebyl podán ¾ádný popis cvièení';
...
$string['pleaseviewtheexercise'] = 'Prosím, zobrazte si cvièení uvedené ní¾e kliknutím na jeho název.<br />
Postupujte podle instrukcí v tomto cvièení. Pokud si myslíte,<br />
¾e jste cvièení úspì¹nì dokonèili, kliknìte na odkaz Hodnotit (nebo Pøehodnotit) <br />
napravo od názvu. A¾ provedete toto hodnocení, dostanete instrukce,<br />
jak dále postupovat.';
$string['poor'] = 'Slabý';
...
kliknutím na tlaèítko <b>Povolit pro $a znovuodevzdání</b>. <br />
Student mù¾e znovuodevzdat úkol, kdy¾ je tento pøíznak pøítomen na <b>jakémkoli</b> z jeho odevzdaných úkolù.';
$string['rubric'] = 'Oddíl';
$string['savedok'] = 'V poøádku ulo¾eno';
$string['saveentries'] = 'Ulo¾it polo¾ky';
$string['savemyassessment'] = 'Ulo¾it mé hodnocení';
$string['saveweights'] = 'Ulo¾it váhy';
$string['scale10'] = 'Poèet bodù z 10';
$string['scale100'] = 'Poèet bodù ze 100';
$string['scale20'] = 'Poèet bodù z 20';
$string['scalecorrect'] = '2 bodová stupnice Správnì/Nesprávnì';
$string['scaleexcellent4'] = '4 bodová stupnice Výbornì/Velmi slabì';
$string['scaleexcellent5'] = '5 bodová stupnice Výbornì/Velmi slabì';
$string['scaleexcellent7'] = '7 bodová stupnice Výbornì/Velmi slabì';
...
$string['studentsubmissions'] = '$a Odevzdaných úkolù';
...
$string['submissionsnowclosed'] = 'Termín uzávìrky vypr¹el a odevzdávání vypracovaných úkolù je uzavøeno';
$string['submitexercisedescription'] = 'Odeslat popis cvièení';
...
$string['theexercise'] = 'Cvièení';
$string['theexerciseandthesubmissionby'] = 'Cvièení a odevzdané úkoly, které zpracoval $a';
$string['thegradeis'] = 'Poèet bodù je $a';
$string['thereisfeedbackfromthe'] = 'Do¹la vyjádøení od: $a';
$string['thisisaresubmission'] = 'Toto je znovu odevzdáný úkol, který vypracoval(a) $a.<br />
Je zobrazeno i va¹e hodnocení pøedchozích odevzdání.<br />
Po prohlédnutí nového odevzdaného úkolu doplòte, prosím, toto hodnocení<br /> 
