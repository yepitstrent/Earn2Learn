...
$string['configenablerssfeeds'] = 'See lüliti lülitab sisse RSS sööda iga foorumi jaoks. Sa pead ikka igas foorumis manuaalselt sööta sisse lülitama.';
...
$string['configoldpostdays'] = 'Päevade vanus mil posti peetakse loetavaks';
$string['configreplytouser'] = 'Kui foorumi postitus välja saadetakse kas ta peaks sisaldama kasutaja e-posti aadressi ,et vastu võtjad saaksid personaalselt vastata foorumis kirjutamise asemel. Isegi kui see on valitud \"jah\" saab kasutaja  oma profiilis valida kas hoida oma e-post aadress salastatuna';
$string['configshortpost'] = 'Kõik postitused mis on sellest pikkusest (ei arvestata HTML\'i) lühemad, loetakse lühikeseks.';
$string['configtrackreadposts'] = 'Pane \"jah\" kui sa soovid jälgida loetud/lugemata iga kasutaja jaoks';
$string['configusermarksread'] = 'Pane \"jah\" nad peavad manuaalsed märkima posti kui loetud. Kui \"ei\" siis seda posti vaadatakse kui lugemata';
...
$string['digestmailheader'] = 'See on sinu päevane uute postituste läbi töötlus $a->sitename foorumilt. Foorumi e-posti seadistuste vahetamiseks mine $a->userprefs';
$string['digestmailprefs'] = 'Sinu kasutajaprofiil';
$string['digestmailsubject'] = '$a: Läbi töötatud foorum';
$string['digestsentusers'] = 'E-posti läbitöötlus edukalt saadetud $a kasutajatele';
...
$string['markread'] = 'Märgi loetud';
$string['markunread'] = 'Märgi mitte loetud';
...
$string['processingdigest'] = 'läbi töötatud e-kirjade protsessimine kasutaja 	$a jaoks';
