<?PHP // $Id: journal.php,v 1.2.12.3 2006/02/06 10:00:26 moodler Exp $ 
...
$string['notstarted'] = "Ainda não começou este diário";
$string['overallrating'] = "Avaliação global";
$string['rate'] = "Taxa";
$string['saveallfeedback'] = "Gravar todos os meus comentários";
$string['startoredit'] = "Começar ou editar a minha entrada de diário";
$string['viewallentries'] = "Ver todas as entradas no diário";
