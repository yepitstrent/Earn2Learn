<?PHP // $Id: moodle.php,v 1.27.2.4 2006/02/06 10:00:26 moodler Exp $ 
...
$string['clambroken'] = 'O administrador do seu sistema activou a opção de detecção de vírus para os ficheiros enviados, mas algo ficou mal configurado.<br />O seu ficheiro NÂO foi recebido com sucesso. Foi enviada uma mensagem de correio electrónico para o adminstrador, pedindo-lhe para corregir o problema.<br />Pode tentar enviar o ficheiro mais tarde.';
...
Alguém (provávelmente você) pediu que fosse gerada uma nova palavra chave para a sua conta no servidor \'$a->sitename\'.
...
$string['moduledeletefiles'] = 'Todos os dados associados ao módulo \'$a->module\' foram eliminados da base de dados. Para completar a eliminação (e previnir que o módule se reinstale), deverá apagar agora este directória do seu servidor: $a->directory';
...
$string['passwordconfirmchange'] = 'Confirme alteração de password';
...
$string['readinginfofrombackup'] = 'Lendo info da cópia de segurança';
...
$string['uploadfailednotrecovering'] = 'Arecepção do ficheiro que enviou falhou devido a um problema com um dos ficheiros, $a->name.<br />Os problemas encontrados foram:<br />
...
$string['uploadrenamedcollision'] = 'O ficheiro foi renomeado de $a->oldname para $a->newname devido a um conflicto no nome.';
...
Uma das primeiras coisas que deveria fazer é editar a sua página de perfil dentro da disciplina, para que possamos conhecé-lo(a) melhor:
