<?php  // $Id: lib.php,v 1.374.2.11 2006/01/16 02:57:06 moodler Exp $
...
function print_e2l_course($course, $width="100%") {
    ...
    echo '<tr valign="top">';
    echo '<td valign="top" width="100%" class="info">';
