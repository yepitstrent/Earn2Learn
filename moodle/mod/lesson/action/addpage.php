...
/************** add page ************************************/
    ...
    <tr><td><div><div><b>Youtube URL:</b>&nbsp;<i>example "https://www.youtube.com/watch?v=abCdEfGHiJk"</i></div><div><input type="text" id="youtube" name="youtube" size="80" maxsize="255" value=""></div></div></td></tr>
