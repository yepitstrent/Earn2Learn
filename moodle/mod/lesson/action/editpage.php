...
/************** edit page ************************************/
    ...
    <tr>
        <td>
	    <div>
                <div><b>Youtube URL:</b>&nbsp;<i>example "https://www.youtube.com/watch?v=aBCdEFghIjk"</i></div>
		<div><input type="text" id="youtube" name="youtube" size="80" maxsize="255" value="<?php if($page->youtube != NULL){
		                                                                                             p("https://www.youtube.com/watch?v=".$page->youtube);
		                                                                                         } ?>">
		</div>
	    </div>
	</td>
