<?php // $Id: markposts.php,v 1.7.2.1 2006/03/13 12:52:38 moodler Exp $
    ...
    $f    = required_param('f');                              // The forum to mark
    $mark = required_param('mark');                           // Read or unread?
    $d    = optional_param('d');                              // Discussion to mark.
