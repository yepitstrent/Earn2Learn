...
/*
$Id: nusoap.php,v 1.2 2005/05/06 06:24:03 gustav_delius Exp $
...
* @version  $Id: nusoap.php,v 1.2 2005/05/06 06:24:03 gustav_delius Exp $
* @access   public
*/
class nusoap_base {
	...
	*/
	function buildVal($pos){
		...
		if($this->message[$pos]['children'] != ''){
            ...
            // array
			} elseif($this->message[$pos]['type'] == 'array' || $this->message[$pos]['type'] == 'Array' || ereg('^ArrayOf', $this->message[$pos]['type'])){
...
// This won't work where native PHP SOAP support is present
// so the new name should be used whenever possible
